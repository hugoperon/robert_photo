            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-4 text-gray-300">
                ...
                <div>
                  ...
                  <a href="mailto:contact@robert-photo.fr" className="text-blue-400 hover:text-blue-300 text-lg">
                    contact@robert-photo.fr
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 text-gray-300">
                ...
                <div>
                  ...
                  <a href="https://instagram.com/robert_photo" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 text-lg">
                    @robert_photo
                  </a>
                </div>
              </div>
